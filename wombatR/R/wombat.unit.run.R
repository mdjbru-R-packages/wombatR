#' @title Run one Wombat analysis
#'
#' @description Thin wrapper to run a single Wombat analysis. 
#'
#' @details This function is just calling Wombat with a specified parameter
#'   parameter file.
#'
#' @param parameter.file path to the parameter file (e.g. file generated by
#'   \code{\link{wombat.write.parameters}}). This path MUST end with
#'   \code{".par"}.
#' @param wombat.bin path to the wombat executable
#'
#' @return None.
#'
#' @examples
...
wombat.unit.run = function(parameter.file,
  wombat.bin = "/home/matthieu/bin/wombat/wombat") {

  # check that the parameter.file ends with ".par"

  stopifnot(grepl("\\.par$", parameter.file))
  
  command_line = paste(wombat.bin, parameter.file, sep = " ")
